...
GetStatusResult _$GetStatusResultFromJson(Map<String, dynamic> json) =>
    GetStatusResult(json['api_version'])
      ...
      ..ourPublicSigningKey = const ClPublicKeyJsonConverter().fromJson(
        json['our_public_signing_key'] as String,
      )
      ...
      ..uptime = const HumanReadableDurationJsonConverter().fromJson(
        json['uptime'] as String,
      );

Map<String, dynamic> _$GetStatusResultToJson(
  GetStatusResult instance,
) => <String, dynamic>{
  ...
  'our_public_signing_key': const ClPublicKeyJsonConverter().toJson(
    instance.ourPublicSigningKey,
  ),
  ...
  'uptime': const HumanReadableDurationJsonConverter().toJson(instance.uptime),
};
