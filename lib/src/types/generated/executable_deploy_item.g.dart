...
ModuleBytesDeployItem _$ModuleBytesDeployItemFromJson(
  ...
  ..moduleBytes = const NullableHexStringBytesJsonConverter().fromJson(
...
Map<String, dynamic> _$ModuleBytesDeployItemToJson(
  ...
  'module_bytes': const NullableHexStringBytesJsonConverter().toJson(
    instance.moduleBytes,
  ),
};
...
_$StoredVersionedContractByHashDeployItemFromJson(Map<String, dynamic> json) =>
    StoredVersionedContractByHashDeployItem(
      json['hash'] as String,
...
_$StoredVersionedContractByNameDeployItemFromJson(Map<String, dynamic> json) =>
    StoredVersionedContractByNameDeployItem(
      json['name'] as String,
      (json['version'] as num?)?.toInt(),
      json['entry_point'] as String,
