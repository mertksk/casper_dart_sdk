...
BlockHeader _$BlockHeaderFromJson(Map<String, dynamic> json) => BlockHeader()
  ...
  ..timestamp = const DateTimeJsonConverter().fromJson(
...
BlockBody _$BlockBodyFromJson(Map<String, dynamic> json) => BlockBody(
  ...
  (json['transfer_hashes'] as List<dynamic>).map((e) => e as String).toList(),
);
...
EraEnd _$EraEndFromJson(Map<String, dynamic> json) => EraEnd(
  ...
  const ValidatorWeightJsonListConverter().fromJson(
    json['next_era_validator_weights'] as List,
  ),
);

Map<String, dynamic> _$EraEndToJson(EraEnd instance) => <String, dynamic>{
  'era_report': instance.eraReport.toJson(),
  'next_era_validator_weights': const ValidatorWeightJsonListConverter().toJson(
    instance.nextEraValidatorWeights,
  ),
};
...
EraReport _$EraReportFromJson(Map<String, dynamic> json) => EraReport(
  ...
  const ClPublicKeyJsonListConverter().fromJson(
    json['inactive_validators'] as List,
  ),
...
Map<String, dynamic> _$EraReportToJson(EraReport instance) => <String, dynamic>{
  'equivocators': const ClPublicKeyJsonListConverter().toJson(
    instance.equivocators,
  ),
  'inactive_validators': const ClPublicKeyJsonListConverter().toJson(
    instance.inactiveValidators,
  ),
