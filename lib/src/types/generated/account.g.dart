...
Account _$AccountFromJson(Map<String, dynamic> json) => Account(
  const AccountHashKeyJsonConverter().fromJson(json['account_hash'] as String),
  ActionThresholds.fromJson(json['action_thresholds'] as Map<String, dynamic>),
...
Map<String, dynamic> _$AccountToJson(Account instance) => <String, dynamic>{
  'account_hash': const AccountHashKeyJsonConverter().toJson(
    instance.accountHash,
  ),
  'action_thresholds': instance.actionThresholds.toJson(),
  'associated_keys': instance.associatedKeys.map((e) => e.toJson()).toList(),
...
ActionThresholds _$ActionThresholdsFromJson(Map<String, dynamic> json) =>
    ActionThresholds(
      (json['deployment'] as num).toInt(),
      (json['key_management'] as num).toInt(),
    );
...
AssociatedKey _$AssociatedKeyFromJson(Map<String, dynamic> json) =>
    AssociatedKey(
      const AccountHashKeyJsonConverter().fromJson(
