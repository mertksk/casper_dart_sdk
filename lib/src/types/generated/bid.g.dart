...
Bid _$BidFromJson(Map<String, dynamic> json) => Bid(
  ...
  (json['delegation_rate'] as num).toInt(),
  ...
  const ClPublicKeyNullableJsonConverter().fromJson(
...
Map<String, dynamic> _$BidToJson(Bid instance) => <String, dynamic>{
  ...
  'delegators': const DelegatorJsonListConverter().toJson(instance.delegators),
  'inactive': instance.inactive,
  'staked_amount': instance.stakedAmount.toString(),
  'validator_public_key': const ClPublicKeyNullableJsonConverter().toJson(
